...
class auth extends CI_Controller {
	...
	{
		//jika sudah login tidak bisa access halam login lagi(ini session log in)
	...
	public function registration()
	{
		...
		$this->form_validation->set_rules('password1', 'Password', 'required|trim|min_length[3]|matches[password2]', [
			'mathches' => 'Password dont matches!',
	...
	public function logout()
	{
		...
		$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">You heve been Logged out</div> ');
			redirect('auth');
	}
